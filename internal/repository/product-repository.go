...
type ProductRepository interface {
	GetProductByID(ctx context.Context, id uuid.UUID) (structs.ProductStruct, error)
	CreateProduct(ctx context.Context, product *structs.Product) error
}

// pgxProductRepo implements ProductRepository using pgxpool
type pgxProductRepo struct {
	db *pgxpool.Pool
}

// NewPGXProductRepo constructs a new repository over a pgxpool
func NewPGXProductRepo(db *pgxpool.Pool) ProductRepository {
	return &pgxProductRepo{db: db}
}

func (r *pgxProductRepo) CreateProduct(ctx context.Context, p *Product) error {
...
func (r *pgxProductRepo) GetProductByID(ctx context.Context, id uuid.UUID) (*Product, error) {
	const query = `
...
func (r *pgxProductRepo) GetAllProduct(ctx context.Context) ([]*Product, error) {
	const query = `
        SELECT id, name, price_cents, released_at, discontinued_at
        FROM products
    `
...
func (r *pgxProductRepo) UpdateProduct(ctx context.Context, p *Product) error {
	const query = `
        UPDATE products
...
func (r *pgxProductRepo) DeleteProduct(ctx context.Context, id uuid.UUID) error {
